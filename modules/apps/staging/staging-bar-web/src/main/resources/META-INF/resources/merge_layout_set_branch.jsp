...
<script>
	function <portlet:namespace />selectLayoutSetBranch(layoutSetBranchId) {
		...
		if (layoutSetBranch) {
			var mergeLayoutSetBranchId = layoutSetBranch.getAttribute.dataset.layoutSetBranchId;
			var mergeLayoutSetBranchMessage = layoutSetBranch.getAttribute.dataset.layoutSetBranchMessage;
			...
			if (confirm(mergeLayoutSetBranchMessage)) {
				Liferay.Util.postForm(
					...
					{
						data: {
							<portlet:namespace />mergeLayoutSetBranchId: mergeLayoutSetBranchId
						}
					}
				);
			}
