...
/**
 * Provides the local service interface for FVSFrontendDataSetEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FVSFrontendDataSetEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FVSFrontendDataSetEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.frontend.view.state.service.impl.FVSFrontendDataSetEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fvs frontend data set entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FVSFrontendDataSetEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
