...
public class SaveTableSectionsMVCResourceCommand
	...
	protected void doTransactionalCommand(
		...
		String objectDefinitionName = "FDSField";

		if (FeatureFlagManagerUtil.isEnabled("LPD-15729")) {
			objectDefinitionName = "DataSetTableSection";
		}

		ObjectDefinition objectDefinition =
			_objectDefinitionLocalService.fetchObjectDefinition(
				themeDisplay.getCompanyId(), objectDefinitionName);
		...
		String objectDefinitionRelationshipName =
			"r_fdsViewFDSFieldRelationship_c_fdsViewId";

		if (FeatureFlagManagerUtil.isEnabled("LPD-15729")) {
			objectDefinitionRelationshipName =
				"r_dataSetTableSections_c_dataSetId";
		}
		...
		for (int i = 0; i < creationDataJSONArray.length(); i++) {
			...
			ObjectEntry objectEntry = _objectEntryService.addObjectEntry(
				...
				HashMapBuilder.<String, Serializable>put(
					objectDefinitionRelationshipName, dataSetId
				).put(
					"label_i18n",
					HashMapBuilder.put(
