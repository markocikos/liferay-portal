...
<script>
	...
	function <portlet:namespace />updateRanksLanguage() {
		...
		if (ranksTempTextarea) {
			...
			var selLanguageId = Liferay.Util.getFormElement(form, 'ranksLanguageId').value;
	...
	function <portlet:namespace />updateRanksLanguageTemps(lang) {
		...
		if (lang != '<%= defaultLanguageId %>') {
			var defaultRanksValue = Liferay.Util.getFormElement(form, 'ranks_<%= defaultLanguageId %>').value;
			var ranksValue = Liferay.Util.getFormElement(form, 'ranks_' + lang).value;
	...
	function <portlet:namespace />updatePrioritiesLanguage() {
		...
		var selLanguageId = Liferay.Util.getFormElement(form, 'prioritiesLanguageId').value;
	...
	function <portlet:namespace />updatePrioritiesLanguageTemps(lang) {
		...
		if (lang != '<%= defaultLanguageId %>') {
			for (var i = 0; i < 10; i++) {
				var defaultImage = Liferay.Util.getFormElement(form, 'priorityImage' + i + '_<%= defaultLanguageId %>').value;
				var defaultName = Liferay.Util.getFormElement(form, 'priorityName' + i + '_<%= defaultLanguageId %>').value;
				var defaultValue = Liferay.Util.getFormElement(form, 'priorityValue' + i + '_<%= defaultLanguageId %>').value;

				var priorityImage = Liferay.Util.getFormElement(form, 'priorityImage' + i + '_' + lang).value;
				var priorityName = Liferay.Util.getFormElement(form, 'priorityName' + i + '_' + lang).value;
				var priorityValue = Liferay.Util.getFormElement(form, 'priorityValue' + i + '_' + lang).value;
