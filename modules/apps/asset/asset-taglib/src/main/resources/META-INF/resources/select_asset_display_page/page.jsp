...
<aui:script use="liferay-item-selector-dialog">
	...
	if (assetDisplayPageIdInput && chooseDisplayPageButton && displayPageContainer && displayPageItemRemove && displayPageNameInput && pagesContainerInput) {
		...
		eventsContainer.addEventListener(
			...
			function(event) {
				...
				if (target && target.value === '<%= AssetDisplayPageConstants.TYPE_SPECIFIC %>') {
					displayPageContainer.remove('hide');
				}
				else {
